...
export function renderCollectionReminder(
  ...
  const bodyHtml = `
    ...
    <p style="margin:0 0 16px 0"><strong>Place your items on the verge by 6am</strong> on the morning of collection — or the night before if it's easier.</p>
  ...
  return {
    ...
    html: renderEmailLayout({
      ...
      preheader: `Your verge collection is on ${dateStr} — items out by 6am`,
 ...
 *    Items out by 6am. verco.au/b/COT-E88PNN"
...
export function renderCollectionReminderSMS(
  ...
  return {
    body: `Reminder: verge collection at ${shortAddress} on ${dateStr}. Items out by 6am. ${link}`,
  }
}
