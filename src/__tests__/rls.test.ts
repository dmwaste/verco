...
;(haveDb ? describe : describe.skip)('RLS role matrix', () => {
  ...
  // user_sub_client_allows_area() inside both.
  //
  // The migration is applied TRANSIENTLY inside each rolled-back test
  ...
  describe('Aggregate RPC sub-client guards (VER-287)', () => {
    ...
    const MIGRATION_SQL = readFileSync(
      resolve(
        __dirname,
        '../../supabase/migrations/20260702130000_ver287_subclient_guard_aggregate_rpcs.sql',
      ),
      'utf-8',
    )
