...
**PRs as a request surface: no.** Verco is a private, closed-source repo — it does not take external feature-request PRs. _(Set to `yes` if this repo ever treats external PRs as feature requests; `/triage` reads this flag.)_
